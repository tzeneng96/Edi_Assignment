...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Step 2: Make migrations (this will create new migration files if needed)
    ...
    def seed_initial_data(self):
        ...
        if Employee.objects.count() == 0:
            ...
            emp1 = Employee.objects.create(name='Alice', employee_id='E101', hourly_rate=30.0)
            emp2 = Employee.objects.create(name='Bob', employee_id='E102', hourly_rate=25.0)
        ...
        if TeamLeader.objects.count() == 0:
            ...
            TeamLeader.objects.create(employee=emp1)  # Assign the first employee as Team Leader
